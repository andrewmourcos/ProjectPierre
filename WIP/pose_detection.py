                ...
                while cv2.waitKey(1) < 0:
                        ...
                        try:
                                ...
                                if head_counter > 5:
                                        ...
                                        requests.get('https://roberttoyonaga.api.stdlib.com/pierre-sms@dev/?name=stop_moving_head')
                                        requests.get('https://roberttoyonaga.api.stdlib.com/pierre-sheets@dev/?operation=set&data='+str(head_counter)+
                                        '&myKey='+name+'_'+'head_counter')
                                ...
                                if r_arm_counter > 5:
                                        ...
                                        requests.get('https://roberttoyonaga.api.stdlib.com/pierre-sms@dev/?name=stop_moving_arm')
                                        requests.get('https://roberttoyonaga.api.stdlib.com/pierre-sheets@dev/?operation=set&data='+str(r_arm_counter)+
                                        '&myKey='+name+'_'+'r_arm_counter')
                                        r_arm_counter = 0
                                        r_arm_start = time.time()
                                ##### Moving right arm #####
